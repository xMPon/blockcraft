...
import {
  ...
  I_FURNACE, I_GLASS, I_STONE, I_IRON_INGOT, I_GOLD_INGOT, I_RAW_IRON, I_RAW_GOLD, I_SAND, I_DIAMOND,
  I_WOOD_PICKAXE, I_STONE_PICKAXE, I_IRON_PICKAXE, I_DIAMOND_PICKAXE,
  I_WOOD_AXE, I_STONE_AXE, I_IRON_AXE, I_DIAMOND_AXE,
  I_WOOD_SHOVEL, I_STONE_SHOVEL, I_IRON_SHOVEL, I_DIAMOND_SHOVEL,
  I_WOOD_SWORD, I_STONE_SWORD, I_IRON_SWORD, I_DIAMOND_SWORD,
